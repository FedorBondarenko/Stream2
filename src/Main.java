    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 10_000_000; i++) {
            persons.add(new Person(
                    ...
                    families.get(new Random().nextInt(((List<?>) families).size())),
        ...
        List<String> conscrits = persons.stream()
                .filter(person -> person.getSex() == Sex.MAN && person.getAge() >= 18 && person.getAge() <= 27)
                .map(Person::getFamily)
                .collect(Collectors.toList());
        // System.out.println("Список призывников :" + conscrits);
        ...
        List<Person> workables = persons.stream()
                ...
                .collect(Collectors.toList());
       // System.out.println("Список работоспособных: " + workables);
    }
}